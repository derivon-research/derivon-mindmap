...
import largeScaleMathAuthoring from './workspaceAssets/derivon-math-authoring/references/large-scale-authoring.md?raw';
...
export const WORKSPACE_AGENT_REFERENCE_SET = 'provisional-2026-08-26-batched-math-authoring';
...
export const WORKSPACE_AGENT_FILES: Readonly<Record<string, string>> = Object.freeze({
  ...
  '.agents/skills/derivon-math-authoring/references/large-scale-authoring.md': largeScaleMathAuthoring,
  ...
  '.claude/skills/derivon-math-authoring/references/large-scale-authoring.md': largeScaleMathAuthoring,
  ...
  '.github/skills/derivon-math-authoring/references/large-scale-authoring.md': largeScaleMathAuthoring,
